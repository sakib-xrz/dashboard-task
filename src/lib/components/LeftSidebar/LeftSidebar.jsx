        ...
        <aside>
            ...
            <div className="p-3 lg:hidden">
                <button
                    ...
                    className="w-full bg-transparent text-teal-600 border border-teal-600 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-between capitalize"
                    type="button"
                >
                    {pathname === "/"
                        ? "Dashboard"
