...
export default function Home() {
  return (
    <div className="space-y-5">
      <h2 className="text-3xl lg:text-5xl font-medium text-gray-800 text-center">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
        <Link
          href={"/teacher"}
          className="flex justify-between items-center w-full px-5 py-4 rounded-md cursor-pointer shadow"
        >
        ...
        <Link
          href={"/student"}
          className="flex justify-between items-center w-full px-5 py-4 rounded-md shadow"
        >
          <div className="space-y-1">
            <h5 className="text-md font-medium text-gray-600">
              Total Student
